...
ACCOUNT_EMAIL = os.environ["LOGIN_EMAIL"]
ACCOUNT_PASSWORD = os.environ["LOGIN_PASSWORD"]
...
chrome_driver_path = ChromeDriverManager(path=os.environ["CHROME_DRIVER_FOLDER"]).install()
